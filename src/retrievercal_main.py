...
def parse_args() -> CalibConfig:
    ...
    p.add_argument("--model_kind", default="retrievercal",
                   choices=["retrievercal", "scoresetcal", "embcal", "embsetcal", "embeddingcal", "embeddingsetcal", "step1", "step2", "step3", "setcal"])
    ...
    p.add_argument("--use_gor2023_eval", action="store_true", help="Compute GOR2023 IA-weighted Fmax during validation.")
    p.add_argument("--gor2023_ia_path", default="", help="Headerless GO_ID IA file for the active GOR2023 branch.")
